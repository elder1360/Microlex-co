/*------ /joomla25/zaara/media/system/js/mootools-core.js ------*/
...
/*------ /joomla25/zaara/media/system/js/core.js ------*/
...
Joomla.submitform = function(a, b) {
    if ("undefined" === typeof b && (b = document.getElementById("adminForm"),
    !b))
...
Joomla.tableOrdering = function(a, b, c, d) {
    if ("undefined" === typeof d && (d = document.getElementById("adminForm"),
    !d))
...
;
/*------ /joomla25/zaara/media/system/js/caption.js ------*/
...
/*------ /joomla25/zaara/media/system/js/mootools-more.js ------*/
...
/*------ /joomla25/zaara/plugins/system/helix/js/menu.js ------*/
...
/*------ /joomla25/zaara/plugins/system/helix/js/totop.js ------*/
...
eval(function(p, a, c, k, e, r) {
    ...
    ;while (c--)
        if (k[c])
            p = p.replace(new RegExp('\\b' + e(c) + '\\b','g'), k[c]);
    return p
}('1.6(\'c\',2(){3 4.7();5 0=i.8(\'9\');a(0){5 b=3 4.d(1);0.6(\'f\',2(e){e.h();b.g()})}});', 19, 19, 'toplink|window|function|new|Fx|var|addEvent|SmoothScroll|id|topofpage|if||domready|Scroll||click|toTop|stop|document'.split('|'), 0, {}))
